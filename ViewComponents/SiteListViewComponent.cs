...
namespace DotNetNote.ViewComponents
{
    public class SiteListViewComponent : ViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            {
                new Site{Id = 1, Title="길벗 출판사", Url="http://www.gilbut.co.kr", Description = "ASP.NET Core 3.0 서적 출간"},
                ...
                new Site{Id = 6, Title="비주얼 아카데미", Url="http://www.youtube.com/user/visualacademy", Description="박용준 MVP 개인 유튜브 채널"},
